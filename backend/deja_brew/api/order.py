...
from deja_brew.repository import (
    db,
    Order,
    OrderStatus as OrderStatus_,
    CupSize as CupSize_,
    Extra as Extra_,
    CoffeeType as CoffeeType_,
    MilkType as MilkType_,
)
...
class OrdersView(MethodView):
    ...
    def post(self):
        ...
        return CreateOrderResponse().dump(dict(order=order))
...
class OrderView(MethodView):
    ...
    def post(self, order_id: str):
        ...
        return UpdateOrderResponse().dump(dict(order=order))
